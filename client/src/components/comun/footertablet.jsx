...
export default function FooterTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional,
            ...
            <div className='' style={{width: '100%', height: 60 / proporcional, marginBottom: 20 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: '100%', height: 60 / proporcional, marginBottom: 25 / proporcional}}>
                    <p className='' 

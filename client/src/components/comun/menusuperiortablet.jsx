    ...
    return (
        <div className='shadow rounded-bottom' style={{width: '100%', height: 'auto'}}>
            <div style={{width: '100%', height: 'auto', background: 'rgba(39, 39, 39, 0.4)'}}>
                <div style={{width: '100%', height: 'auto', paddingTop: 14 / proporcional, paddingBottom: 14 / proporcional, paddingLeft: 60 / proporcional, 
                    paddingRight: 60 / proporcional}}>
                    <div className='d-flex' style={{width: '100%', height: 32 / proporcional}}>
                        <div className='d-flex justify-content-start' style={{width: '32%', height: 32 / proporcional}}>
                        ...
                        <div className='d-flex' style={{width: '32%', height: 32 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 32 / proporcional}}>
                        ...
                        <div className='d-flex justify-content-end' style={{width: '32%', height: 32 / proporcional}}>
                ...
                <div style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 148 / proporcional}}>
                        <div className='d-flex justify-content-start rounded-left'
                             style={{width: '74%', height: 148 / proporcional, paddingTop: 30 / proporcional}}>
                    ...
                    <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex justify-content-start' style={{width: '100%', height: 'auto'}}>
                            <div className='d-flex justify-content-center' style={{width: '16.7%', height: 60 / proporcional}}>
                                <div className='d-flex justify-content-center position-relative' style={{width: '60%', height: 60 / proporcional, cursor: 'pointer', 
                                    borderBottom: (seleccion_menu === 'inicio' || location.pathname.split ('/')[1] === '') ? '4px solid #4a9ae9' : '',
                            ...
                            <div className='d-flex justify-content-center' style={{width: '16.7%', height: 60 / proporcional}}>
                                <div className='d-flex justify-content-center position-relative' style={{width: '60%', height: 60 / proporcional, cursor: 'pointer', 
                                    borderBottom: (seleccion_menu === 'nosotros' || location.pathname.split ('/')[1] === 'sobre-nosotros') ? '4px solid #4a9ae9' : '',
                            ...
                            <div className='d-flex justify-content-center' style={{width: '16.7%', height: 60 / proporcional}}>
                                <div className='d-flex justify-content-center position-relative' style={{width: '60%', height: 60 / proporcional, cursor: 'pointer', 
                                    borderBottom: (seleccion_menu === 'servicios' || location.pathname.split ('/')[1] === 'nuestros-servicios') ? '4px solid #4a9ae9' : '',
                                    ...
                                    </p>
                                    {
                                        seleccion_menu == 'servicios' ? (
                                            <div className='position-absolute start-0 shdow rounded' style={{width: 300 / proporcional,  height: 'auto', paddingTop: 20 / proporcional, 
                                                paddingBottom: 20 / proporcional, background: 'rgb(24, 54, 80)', top: 60 / proporcional, zIndex: 9999}}>
                                                <p className='' 
                            ...
                            <div className='d-flex justify-content-center' style={{width: '16.7%', height: 60 / proporcional}}>
                                <div className='d-flex justify-content-center position-relative' style={{width: '60%', height: 60 / proporcional, cursor: 'pointer', 
                                    borderBottom: (seleccion_menu === 'noticias' || location.pathname.split ('/')[1] === 'noticias') ? '4px solid #4a9ae9' : '',
                            ...
                            <div className='d-flex justify-content-center' style={{width: '16.7%', height: 60 / proporcional}}>
                                <div className='d-flex justify-content-center position-relative' style={{width: '60%', height: 60 / proporcional, cursor: 'pointer', 
                                    borderBottom: (seleccion_menu === 'galeria' || location.pathname.split ('/')[1] === 'galeria') ? '4px solid #4a9ae9' : '',
                            ...
                            <div className='d-flex justify-content-center' style={{width: '16.7%', height: 60 / proporcional}}>
                                <div className='d-flex justify-content-center position-relative' style={{width: '60%', height: 60 / proporcional, cursor: 'pointer', 
                                    borderBottom: (seleccion_menu === 'contacto' || location.pathname.split ('/')[1] === 'contactanos') ? '4px solid #4a9ae9' : '',

...
export default function FooterTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
                background: '#1c4c96'}}>
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', paddingBottom: 50 / proporcional, borderBottom: '1px solid white', marginBottom: 20 / proporcional}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', paddingBottom: 50 / proporcional, borderBottom: '1px solid white', marginBottom: 20 / proporcional}}>
                <div style={{width: '90%', height: 'auto', paddingLeft: 50 / proporcional}}>
            ...
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <p className='' 
                        style={{fontSize: 14 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 0 / proporcional, color: 'white',
                                fontWeight: 600, fontFamily: 'Roboto, sans-serif', cursor: 'default'}}>

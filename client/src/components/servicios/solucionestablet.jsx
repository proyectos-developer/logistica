...
export default function SolucionesTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex justify-content-end' style={{width: '48%', height: '80%'}}>
                    <img src={image_servicios} style={{width: '100%', height: 317 / proporcional}}/>
                </div>
            </div>
        </div>
    )

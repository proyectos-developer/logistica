...
export default function CaracteristicasServicioCell({proporcional}) {

    return (
        <div style={{width: '100%', height: 'auto', background: 'rgb(52, 204, 255)'}}>
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '90%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional,
                        background: '#34ccff'}}>

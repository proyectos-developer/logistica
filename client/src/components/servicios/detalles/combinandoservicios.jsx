...
export default function CombinandoServicios({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', background: 'rgb(247, 247, 247)'}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, paddingLeft: 200 / proporcional,

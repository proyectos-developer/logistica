...
import CaracteristicasCell from '../servicios/caracteristicascell.jsx'

export default function CotizacionPanelCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional, marginBottom: 60 / proporcional}}>

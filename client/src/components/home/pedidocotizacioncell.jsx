...
export default function PedidoCotizacionTablet({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, background: '#1c4c96',
                paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, marginBottom: 50 / proporcional}}>

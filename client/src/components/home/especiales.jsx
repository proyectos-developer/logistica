...
export default function Especiales({proporcional}) {
        
    return (
        <div className='' style={{width: '48%', height: 'auto', paddingTop: 150 / proporcional, paddingBottom: 150 / proporcional}}>
            ...
            <div className='d-flex justify-cotent-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <div className='d-flex' style={{width: '48%', height: 72 / proporcional}}>
            ...
            <div className='d-flex justify-cotent-between' style={{width: '100%', height: 'auto'}}>
                <div className='d-flex' style={{width: '48%', height: 72 / proporcional}}>

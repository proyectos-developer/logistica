...
export default function PedidoCotizacion({proporcional}) {
    ...
    return (
        <div className='' style={{width: '48%', height: 'auto', paddingTop: 150 / proporcional, paddingBottom: 150 / proporcional, background: '#1c4c96',

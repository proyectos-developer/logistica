...
export default function SliderPrincipal({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div id='carouselhomeprincipal' className='carousel slide' data-bs-ride='carousel' style={{width: '100%', height: 1000 / proporcional}}>
                ...
                <div className='carousel-inner' style={{width: '100%', height: 1000 / proporcional}}>
                    <div className='carousel-item active' data-bs-interval='3000' style={{width: '100%', height: 1000 / proporcional}}>
                        <div className='' 
                            style={{width: '100%', height: 1000 / proporcional, backgroundImage: `url(${image_00})`, backgroundPosition: 'cencter', backgroundSize: 'cover', 
                                backgroundRepeat: 'no-repeat'}}>
                            <div className='position-relative' style={{width: '100%', height: 1000 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}>
                                <div className='position-absolute rounded shadow' style={{width: 540 / proporcional, height: 340 / proporcional, left: 200 / proporcional, top: 330 / proporcional,
                                    background: 'rgba(39, 39, 39, 0.6)'}}>
                                    <div style={{width: '100%', height: '100%', padding: 50 / proporcional}}>
                    ...
                    <div className='carousel-item' data-bs-interval='3000'>
                        <div className='' 
                            style={{width: '100%', height: 1000 / proporcional, backgroundImage: `url(${image_01})`, backgroundPosition: 'cencter', backgroundSize: 'cover', 
                                backgroundRepeat: 'no-repeat'}}>
                            <div className='position-relative' style={{width: '100%', height: 1000 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}>
                                <div className='position-absolute rounded shadow' style={{width: 540 / proporcional, height: 340 / proporcional, left: 200 / proporcional, top: 330 / proporcional,
                                    background: 'rgba(39, 39, 39, 0.6)'}}>
                    ...
                    <div className='carousel-item' data-bs-interval='3000'>
                        <div className='' 
                            style={{width: '100%', height: 1000 / proporcional, backgroundImage: `url(${image_02})`, backgroundPosition: 'cencter', backgroundSize: 'cover', 
                                backgroundRepeat: 'no-repeat'}}>
                            <div className='position-relative' style={{width: '100%', height: 1000 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}>
                                <div className='position-absolute rounded shadow' style={{width: 540 / proporcional, height: 340 / proporcional, left: 200 / proporcional, top: 330 / proporcional,
                                    background: 'rgba(39, 39, 39, 0.6)'}}>
                    ...
                    <div className='carousel-item' data-bs-interval='3000'>
                        <div className='' 
                            style={{width: '100%', height: 1000 / proporcional, backgroundImage: `url(${image_03})`, backgroundPosition: 'cencter', backgroundSize: 'cover', 
                                backgroundRepeat: 'no-repeat'}}>
                            <div className='position-relative' style={{width: '100%', height: 1000 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}>
                                <div className='position-absolute rounded shadow' style={{width: 540 / proporcional, height: 340 / proporcional, left: 200 / proporcional, top: 330 / proporcional,
                                    background: 'rgba(39, 39, 39, 0.6)'}}>

...
export default function NoticiasCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div id='carouselhomenoticas' className='carousel slide'  data-bs-ride='carousel' style={{width: '100%', height: 350 / proporcional}}>
            ...
            <div style={{width: '100%', height: 350 / proporcional, border: '1px solid rgb(139, 139, 139)', borderLeft: '0px', padding: 20 / proporcional, marginBottom: 50 / proporcional}}>
                <p className='' 
            ...
            <div className='d-flex' style={{width: '100%', height: 50 / proporcional, marginBottom: 50 / proporcional}}>
                ...
                <div className='d-flex justify-content-end' style={{width: '50%', height: 50 / proporcional}}>
                    <div className='d-flex justify-content-center rounded-pill' style={{width: '100%', height: 50 / proporcional, border: '1px solid #4a9ae9', cursor: 'pointer',

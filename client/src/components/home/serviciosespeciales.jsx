...
export default function ServiciosEspeciales({proporcional}) {

    return (
        <div style={{width: '100%', height: 'auto', background: '#1c4c96', paddingTop: 150 / proporcional, paddingBottom: 150 / proporcional, paddingLeft: 200 / proporcional, 
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '23%', height: 'auto'}}>
                    ...
                    <p className='' 
                        style={{fontSize: 30 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 50 / proporcional, color: 'white',
                                fontWeight: 400, fontFamily: 'Roboto, sans-serif', cursor: 'default', textAlign: 'left'}}>
                        SERVICIOS <br/>ESPECIALES
                    </p>
                    <p className='' 
                        style={{fontSize: 16 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 50 / proporcional, color: 'rgb(255, 255, 255, 0.5)',
                                fontWeight: 400, fontFamily: 'Roboto, sans-serif', cursor: 'default', textAlign: 'left'}}>

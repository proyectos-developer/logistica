...
export default function IconosSliderTablet({proporcional}) {
    ...
    return (
        <div className='position-absolute' style={{width: '100%', height: 190 / proporcional, top: 630 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 190 / proporcional}}>
                <div className='d-flex justify-content-center' style={{width: '25%', height: 190 / proporcional}}>
                    <img src={icono_camion_white} style={{width: 48 / proporcional, height: 48 / proporcional, marginTop: 71 / proporcional}}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '25%', height: 190 / proporcional}}>
                    <img src={icono_avion_white} style={{width: 48 / proporcional, height: 48 / proporcional, marginTop: 71 / proporcional}}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '25%', height: 190 / proporcional}}>
                    <img src={icono_buque_white} style={{width: 48 / proporcional, height: 48 / proporcional, marginTop: 71 / proporcional}}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '25%', height: 190 / proporcional}}>
                    <img src={icono_almacen_white} style={{width: 48 / proporcional, height: 48 / proporcional, marginTop: 71 / proporcional}}/>
                </div>
            </div>
        </div>
    )

...
export default function Faq({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div className='d-flex' style={{width: '100%', height: 'auto', background: '#4a9ae9', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
                ...
                <div className='d-flex justify-content-end' style={{width: '90%', height: 'auto'}}>
            ...
            <div className='rounded' style={{width: '100%', height: 'auto', border: '1px solid rgb(139, 139, 139)'}}>
                <div className='d-flex' style={{width: '100%', height: 'auto', background: seleccion_pregunta === '1' ? '#4a9ae9' : 'transparent', cursor: 'pointer',
                ...
                <div className='d-flex' style={{width: '100%', height: 'auto', background: seleccion_pregunta === '2' ? '#4a9ae9' : 'transparent', cursor: 'pointer',
                        paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, borderBottom: '1px solid rgb(139, 139, 139)'}} 
                    onMouseOver={() => setSeleccionPregunta('2')} onMouseLeave={() => setSeleccionPregunta('')}>
                    <div className='d-flex justify-content-start' style={{width: '90%', height: 'auto', paddingTop: 5 / proporcional, paddingBottom: 5 / proporcional}}>
                        <p className='' 
                ...
                <div className='d-flex' style={{width: '100%', height: 'auto', background: seleccion_pregunta === '3' ? '#4a9ae9' : 'transparent', cursor: 'pointer',
                        paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, borderBottom: '1px solid rgb(139, 139, 139)'}} 
                ...
                <div className='d-flex' style={{width: '100%', height: 'auto', background: seleccion_pregunta === '4' ? '#4a9ae9' : 'transparent', cursor: 'pointer',

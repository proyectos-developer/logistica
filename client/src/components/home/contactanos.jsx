...
export default function Contactanos({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', height: 350 / proporcional, backgroundImage: `url(${image_contactanos})`, backgroundPosition: 'center', backgroundSize: 'center', 
            ...
            <div className='' 
                style={{background: 'rgba(139, 139, 139, 0.6)', paddingTop: 75 / proporcional, paddingBottom: 75 / proporcional, paddingLeft: 200 / proporcional, paddingRight: 200 / proporcional,
                ...
                <div style={{width: '50%', height: 'auto'}}>
                    ...
                    <button className='btn rounded-pill' style={{width: '40%', height: 50 / proporcional, fontSize: 20 / proporcional, 

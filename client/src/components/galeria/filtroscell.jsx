    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div className='d-flex' style={{width: '100%', height: 55 / proporcional, marginBottom: 50 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: '90%', height: 55 / proporcional}}>
                    ...
                    <div style={{width: '25%', height: 55 / proporcional}}>
                ...
                <div className='d-flex justify-content-ennd' style={{width: '10%', height: 55 / proporcional}}>

...
export default function NuestrosSociosTablet({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 100 / proporcional}}>
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                    <div className='rounded' style={{width: 200 / proporcional, height: 100 / proporcional, border: '1px solid #bdbdbd'}}/>
                    <div className='rounded' style={{width: 200 / proporcional, height: 100 / proporcional, border: '1px solid #bdbdbd'}}/>
                    <div className='rounded' style={{width: 200 / proporcional, height: 100 / proporcional, border: '1px solid #bdbdbd'}}/>
                    <div className='rounded' style={{width: 200 / proporcional, height: 100 / proporcional, border: '1px solid #bdbdbd'}}/>
                    <div className='rounded' style={{width: 200 / proporcional, height: 100 / proporcional, border: '1px solid #bdbdbd'}}/>

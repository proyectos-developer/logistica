...
export default function PregunasFrecuentes({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                ...
                <div className='' style={{width: '100%', height: 'auto'}}>
                    <div style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex' style={{width: '100%', height: 80 / proporcional, background: (seleccion_pregunta === '1' || mouse_pregunta === '1') ? '#4a9ae9' : 'white', 
                            ...
                            <div className='d-flex justify-content-start' style={{width: '90%', height: 40 / proporcional}}>
                                <p className='' 
                                    style={{fontSize: 30 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 30 / proporcional, 
                        ...
                        </div>
                        {
                            seleccion_pregunta === '1' ? (
                                <div style={{width: '100%', height: 'auto', padding: 50 / proporcional}}>
                                    <p className='' 
                                        style={{fontSize: 18 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 30 / proporcional, color: 'rgb(128, 128, 128)',
                                                fontWeight: 500, fontFamily: 'Lato, sans-serif', cursor: 'default'}}>
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex' style={{width: '100%', height: 80 / proporcional, background: (seleccion_pregunta === '2' || mouse_pregunta === '2') ? '#4a9ae9' : 'white', 
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex' style={{width: '100%', height: 80 / proporcional, background: (seleccion_pregunta === '3' || mouse_pregunta === '3') ? '#4a9ae9' : 'white', 
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex' style={{width: '100%', height: 80 / proporcional, background: (seleccion_pregunta === '4' || mouse_pregunta === '4') ? '#4a9ae9' : 'white', 
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        <div className='d-flex' style={{width: '100%', height: 80 / proporcional, background: (seleccion_pregunta === '5' || mouse_pregunta === '5') ? '#4a9ae9' : 'white', 

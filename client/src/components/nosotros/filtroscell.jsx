...
export default function FiltrosCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '90%', height: 'auto', border: '2px solid #4a9ae9', padding: 30 / proporcional, marginBottom: 50 / proporcional}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '90%', height: 'auto', border: '2px solid #4a9ae9', padding: 30 / proporcional, marginBottom: 50 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-start rounded-pill' 
                        ...
                        <p className='' 
                            style={{fontSize: 20 / proporcional, lineHeight: `${25 / proporcional}px`, marginBottom: 0 / proporcional, color: 'black',
                                    fontWeight: 500, fontFamily: 'Roboto, sans-serif', cursor: 'default'}}>

...
export default function NosotrosCell({proporcional}) {
    
    return (
        <div style={{width: '100%', height: 'auto', marginTop: 20 / proporcional}}>
            <div style={{width: '100%', height: 'auto', background: '#fbfbfb', marginBottom: 50 / proporcional}}>

                <div id='carouselnosotrosmain' className='carousel slide' data-bs-ride='carousel' style={{width: '100%', height: 670 / proporcional}}>

                    <div className='carousel-item active' style={{width: '100%', height: 670 / proporcional, background: '#fbfbfb'}} data-bs-interval='3000'>
                        <div className='' style={{width: '100%', height: 'auto'}}>
                            <div className='d-flex' style={{width: '100%', height: 'auto', padding: 50 / proporcional}}>
                                <div style={{width: '15%', height: 'auto'}}>
                                    <img className='rounded-circle' src={icono_comillas} 
                                        style={{width: 48 / proporcional, height: 48 / proporcional, padding: 16 / proporcional, border: '1px solid #4a9ae9', marginRight: 20 / proporcional}}/>
                                </div>
                                <div style={{width: '85%', height: 'auto', marginTop: 0 / proporcional, marginBottom: 0 / proporcional}}>
                                    <p className='' 
                            ...
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                                <img src={image_00} style={{width: 350 / proporcional, height: 'auto'}}/>
                            </div>
                        </div>
                    </div>

                    <div className='carousel-item' style={{width: '100%', height: 670 / proporcional, background: '#fbfbfb'}} data-bs-interval='3000'>
                        <div className='' style={{width: '100%', height: 'auto'}}>
                            <div className='d-flex' style={{width: '100%', height: 'auto', padding: 50 / proporcional}}>
                                <div style={{width: '15%', height: 'auto'}}>
                                    <img className='rounded-circle' src={icono_comillas} 
                            ...
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                                <img src={image_01} style={{width: 350 / proporcional, height: 'auto'}}/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='carousel-item' style={{width: '100%', height: 670 / proporcional, background: '#fbfbfb'}} data-bs-interval='3000'>
                        <div className='' style={{width: '100%', height: 'auto'}}>
                            ...
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                                <img src={image_02} style={{width: 350 / proporcional, height: 'auto'}}/>
                            </div>
                        </div>
                    </div>
                </div>

...
export default function ContactarnosTablet({proporcional}) {
    ...
    return (
        <div className='d-flex justify-content-between' style={{width: '100%', height: 200 / proporcional}}>
            <p className='d-flex justify-content-start' 
                style={{fontSize: 50 / proporcional, lineHeight: `${60 / proporcional}px`, marginBottom: 0 / proporcional, color: 'white',

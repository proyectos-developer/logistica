...
export default function CardNoticiaCell({proporcional, noticia}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', border: '1px solid rgb(128, 128, 128)', marginBottom: 30 / proporcional}}>
            <div className='' style={{width: '100%', height: 'auto'}}>
                <div className='position-relative' style={{width: '100%', height: 300 / proporcional}}>
                    <img src={noticia.image} style={{width: '100%', height: 300 / proporcional}}/>

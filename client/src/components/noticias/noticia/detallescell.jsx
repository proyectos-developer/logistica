...
export default function DetallesCell({proporcional, noticia}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 415 / proporcional, marginBottom: 20 / proporcional}}>
                <img src={noticia.image} style={{width: '100%', height: 360 / proporcional, marginBottom: 20 / proporcional}}/>
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 60 / proporcional}}>
                ...
                <div className='' style={{width: '100%', height: 75 / proporcional, borderLeft: '2px solid rgb(52, 204, 255)', marginLeft: 21 / proporcional,
                    paddingLeft: 20 / proporcional, marginBottom: 26 / proporcional}}>
                    <p className='' 
                        style={{fontSize: 14 / proporcional, lineHeight: `${25 / proporcional}px`, marginBottom: 0 / proporcional, color: 'rgb(128, 128, 128)',
                                fontWeight: 300, fontFamily: 'Roboto, sans-serif', cursor: 'default', textAlign: 'left'}}>
            ...
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 60 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: 'auto', height: 32 / proporcional, marginBottom: 25 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 80 / proporcional}}>
                <div style={{width: '100%', height: 'auto', padding: 30 / proporcional, background: '#f7f7f7'}}>
                    <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: 85 / proporcional, height: 85 / proporcional, background: 'rgb(52, 204, 255)', marginRight: 23 / proporcional}}/>
                        <div style={{width: '100%', height: 'auto'}}>
                            <p className='' 

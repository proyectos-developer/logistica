...
export default function DetallesNoticia({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: '100%'}}>
            ...
            <div style={{width: '100%', height: '100%', paddingLeft: 200 / proporcional, paddingRight: 200 / proporcional}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: '100%'}}>
                    <div style={{width: '68%', height: '100%'}}>
                        <Detalles proporcional={proporcional} noticia={lista_noticias[id_noticia]}/>
                    </div>

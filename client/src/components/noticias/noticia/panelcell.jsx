    ...
    return (
        <div style={{width: '100%', height: '100%'}}>
            <div style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '100%', height: 'auto', paddingTop: 20 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, marginBottom: 80 / proporcional}}>
                    <div style={{width: '100%', height: 50 / proporcional}}>
                        <div className='d-flex' style={{width: '100%', height: 50 / proporcional}}>
                            ...
                            <p className='' 
                                style={{fontSize: 18 / proporcional, lineHeight: `${50 / proporcional}px`, marginBottom: 30 / proporcional, color: 'rgb(128, 128, 128)',
                                        fontWeight: 400, fontFamily: 'Roboto, sans-serif', cursor: 'pointer'}}>
                                {lista_noticias[id_noticia].titulo.slice(0, 10)}...
                            </p>
                        </div>
                    </div>
                </div>
            </div>
            <div style={{width: '100%', height: '100%', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
                <div style={{width: '100%', height: '100%'}}>
                    <DetallesCell proporcional={proporcional} noticia={lista_noticias[id_noticia]}/>
                </div>
